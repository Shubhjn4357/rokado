...
import { adjustStock, getItemDetailsAction } from "@/app/(erp)/inventory/actions";
...
export default function InventoryItemDetailClient({
  ...
  const loadItemData = async () => {
    try {
      const details = await getItemDetailsAction(item.id);
      if (details.success) {
        setStockMovementsData(details.stockMovementsData || []);
        setLinkedVouchers(details.linkedVouchers || []);
      }
            ...
            <CardContent className="space-y-4">
              <form onSubmit={handleAdjustStock} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div>
                    <Label htmlFor="adjustRate">Rate (₹)</Label>
                    <Input
                      id="adjustRate"
                      type="number"
                      min="0"
                  ...
                  <div>
                    <Label htmlFor="adjustNarration">Narration (Optional)</Label>
                    <Input
                      id="adjustNarration"
